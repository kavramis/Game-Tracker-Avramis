...
namespace GameTracker
{
    public partial class LoadResults : Form
    {
        ...
        private void LoadResults_MouseDown(object sender, MouseEventArgs e)
        {
            mouseDown = true;
            lastLocation = e.Location;
        }

        private void LoadResults_MouseMove(object sender, MouseEventArgs e)
        {
            if (mouseDown)
            {
        ...
        private void LoadResults_MouseUp(object sender, MouseEventArgs e)
        {
            mouseDown = false;
        }
    }
